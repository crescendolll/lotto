...
export const Header = () => {
  return (
    <div className='bg-hellgrau my-9 font-bold text-primary flex justify-between px-6 items-center'>
      <div className='h-16 w-16 bg-primary hover:bg-primary_neon'>logo</div>
      ...
      <a className='w-16 bg-primary text-hellgrau px-4 py-2 rounded hover:bg-primary_neon' href='#'>
        Kontoverwaltung
      </a>
    </div>
  )
